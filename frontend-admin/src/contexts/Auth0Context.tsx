/**
 * Auth0 Authentication Context for HRC Kitchen Admin App
 *
 * This context wraps the Auth0 React SDK and provides a compatible interface
 * with the existing AuthContext, including hasAdminAccess for domain validation.
 */
    ...
    const loadUser = async () => {
      if (isAuthenticated && auth0User) {
        try {
          ...
          const adminAccess = auth0User[`${AUTH0_NAMESPACE}/hasAdminAccess`] as boolean || false;
          ...
          localStorage.setItem('hasAdminAccess', String(adminAccess));
        } catch (error) {

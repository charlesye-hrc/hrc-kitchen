...
const onRedirectCallback = (appState?: AppState) => {
  console.log('Auth0 redirect callback (admin), appState:', appState);
  // Navigate to the returnTo path or default to /kitchen
  const returnTo = appState?.returnTo || '/kitchen';
